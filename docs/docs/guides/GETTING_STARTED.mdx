...
VisionCamera requires **iOS 12 or higher**, and **Android-SDK version 21 or higher**. See [Troubleshooting](/docs/guides/troubleshooting) if you're having installation issues.
...
```json
{
  ...
  "plugins": [
    [
      "react-native-vision-camera-support",
      {
